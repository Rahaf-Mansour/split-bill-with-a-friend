...
function App() {
  ...
  function handleSelectedFriend(friend) {
    // If we click close => set the new value of the selectedFriend back to null
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  function handlePaidByUser(e) {
    // if the entered number is grater than bill, then keep the previous paidByUser valuse without setting/ updating it
    setPaidByUser(
